...
// ─── Component ────────────────────────────────────────────────────────────── //
export default function ProjectGallery({ whatsappLink }: { whatsappLink: string }) {
      ...
      >
        <div className="max-w-2xl">
          ...
          <p className="text-xl text-slate-500 font-light mt-4 leading-relaxed">
            AAC blocks are specified across every building typology — from affordable
            housing to five-star hospitality and heavy industrial.
          </p>
        </div>
        <a
      ...
      */}
      <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
        {projects.map((project, i) => (
          ...
          >
            {/* Image / placeholder */}
            <div className={`relative w-full ${project.heightClass} bg-slate-200 overflow-hidden`}>
